...
export interface Messages {
  ...
  devices_howto_step2_completed: string;
  devices_howto_step2_expiry: string;
  devices_howto_step3_heading: string;
  ...
  devices_howto_img_pairing_completed: string;
...
export const I18N: Record<Lang, Messages> = {
  ja: {
    ...
    flasher_intro: "ブラウザからXteink X3/X4へファームウェアをインストールできます。",
    ...
    flasher_instruction_connect: "Xteink X3/X4をポゴピンでPC/Macに接続します。",
    ...
    flasher_instruction_wait: "完了するまで接続を外さずに待ちます。",
    ...
    flasher_warning_disconnect: "書き込み中は接続を外さないでください。",
    ...
    devices_empty_hint: "端末をペアリングするには、CrossPoint JP をフォークした専用ファームウェアのインストールが必要です。",
    ...
    devices_howto_step1_device: "この手順で対応している端末は Xteink X3/X4 です。",
    devices_howto_step1_firmware: "CrossPoint JP をフォークした専用ファームウェアのインストールが必要です。このファームウェアは、端末をこの「XTC 変換」アプリに接続する機能を追加したものです。",
    devices_howto_step1_connect: "Xteink X3/X4 をポゴピンで PC/Mac に接続します。",
    ...
    devices_howto_img_pairing_completed: "端末の画面に「ペアリングが完了しました」と表示されている",
  ...
  en: {
    ...
    flasher_title: "CrossPoint JP",
    flasher_intro: "Install firmware on an Xteink X3/X4 directly from your browser.",
    ...
    flasher_instruction_connect: "Connect the Xteink X3/X4 to your PC or Mac via pogo pins.",
    ...
    flasher_instruction_wait: "Keep the device connected until installation completes.",
    ...
    flasher_warning_disconnect: "Do not disconnect the device during installation.",
    ...
    devices_howto_step1_device: "The devices supported by this procedure are the Xteink X3/X4.",
    ...
    devices_howto_step1_connect: "Connect the Xteink X3/X4 to your PC or Mac via pogo pins.",
    ...
    devices_howto_step2_scan: "Scan the QR code with your computer or phone to open the pairing approval dialog.",
    ...
    devices_howto_step2_completed: "When the device's screen shows “ペアリングが完了しました” (Pairing complete), pairing is done.",
    devices_howto_step2_expiry: "The pairing code expires 10 minutes after it's issued. If it expires, start again on the device.",
    devices_howto_step3_heading: "Step 3: Send a book to the device",
    ...
    devices_howto_img_pairing_completed: "The device's screen showing “ペアリングが完了しました” (Pairing complete)",
